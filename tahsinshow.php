            ...
            <table  style="width:90%;height:100%; color:black; text-align: center;border:2px solid black">
                <tr>
                    ...
                    while($row = mysqli_fetch_array($res)){
                        ...
                        echo '<td style="text-align: center;color:green;border:2px solid black">'.$row['groups'].'</td>';
                        echo '<td style="text-align: center;color:blue;border:2px solid black">'.$row['id'].'</td>';
                        echo '</tr>';
                    }
                    ?>
            </table>
